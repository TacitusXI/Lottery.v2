...
contract HelperConfig is CodeConstants, Script {
        ...
        returns (NetworkConfig memory mainnetNetworkConfig)
    {
        mainnetNetworkConfig = NetworkConfig({
            ...
            account: msg.sender // Use the deployer's address
        });
    }
    ...
    function getPolygonAmoyConfig()
        public
        view
        returns (NetworkConfig memory polygonAmoyNetworkConfig)
    {
        polygonAmoyNetworkConfig = NetworkConfig({
            subscriptionId: 0, // If left as 0, our scripts will create one!
            gasLane: 0x816bedba8a50b294e5cbd47842baf240c2385f2eaf719edbd4f250a137a8c899, // 200 gwei Key Hash
            automationUpdateInterval: 30, // 30 seconds
            lotteryEntranceFee: 0.01 ether,
            callbackGasLimit: 500000, // 500,000 gas
